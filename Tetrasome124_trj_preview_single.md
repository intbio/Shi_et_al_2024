### TETR<sub>124, single run</sub> - tetrasome with 124 bp pseudosymmetric α-satellite DNA, full length histone tails, single run simulation  (PDB ID 1KX5)
...
<script>
  var pdb="trj/remale_1kx5_tetrasome_124_tails_for_web.pdb"
  var xtc="trj/remake_1kx5_tetrasome_124_tails_for_web.xtc"
  var csvfile="dat/remake_1kx5_tetrasome_124_tails_cont_wrap.csv"
  var trjstep = 0.01;
