### TETR<sub>124, merged</sub> - tetrasome with 124 bp pseudosymmetric α-satellite DNA, full length histone tails, merged simulation runs (PDB ID 1KX5)
...
<script>
  ...
  var csvfile="dat/1kx5_tetrasome_124_tails_dist_wrap.csv"
  var trjstep = 0.01;
